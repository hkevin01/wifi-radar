...
class DualBranchEncoder(nn.Module):
    ...
    def __init__(self, num_tx=3, num_rx=3, num_subcarriers=64, hidden_dim=128, output_dim=256):
    ...
    def forward(self, amplitude, phase):
        ...
        amplitude = amplitude.view(batch_size, 1, self.num_tx, self.num_rx * self.num_subcarriers)
        phase = phase.view(batch_size, 1, self.num_tx, self.num_rx * self.num_subcarriers)
